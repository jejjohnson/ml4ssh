...
srun python experiments/dc20a/main.py \
    ...
    --my_config.trainer.num_epochs=50000 \
    ...
    --my_config.dataloader.num_workers_train=10 \
    --my_config.dataloader.num_workers_valid=10 \
    --my_config.dataloader.num_workers_test=10 \
    --my_config.dataloader.num_workers_predict=10 \
